...
hopping_operator('t', [1, 0, 0], -1, band1=2, band2=2)
hopping_operator('t', [0, 1, 0], -1, band1=2, band2=2)
hopping_operator('tp', [1, 1, 0], -1, band1=2, band2=2)
hopping_operator('tp', [1, -1, 0], -1, band1=2, band2=2)
hopping_operator('tpp', [2, 0, 0], -1, band1=2, band2=2)
hopping_operator('tpp', [0, 2, 0], -1, band1=2, band2=2)
hopping_operator('tz', [0, 0, 1], -1, band1=1, band2=2)
hopping_operator('tzp', [1, 1, 1], -1, band1=1, band2=2)
hopping_operator('tzp', [1, -1, 1], -1, band1=1, band2=2)
hopping_operator('tzp', [-1, 1, 1], -1, band1=1, band2=2)
hopping_operator('tzp', [-1, -1, 1], -1, band1=1, band2=2)
hopping_operator('tzpp', [2, 0, 1], -1, band1=1, band2=2)
hopping_operator('tzpp', [0, 2, 1], -1, band1=1, band2=2)
hopping_operator('tzpp', [-2, 0, 1], -1, band1=1, band2=2)
hopping_operator('tzpp', [0, -2, 1], -1, band1=1, band2=2)
hopping_operator('mu1', [0, 0, 0], -1, tau=0, band1=1, band2=1)
hopping_operator('mu2', [0, 0, 0], -1, tau=0, band1=2, band2=2)
anomalous_operator('S1', [1, 0, 0], 1, band1=1, band2=1)
anomalous_operator('S1', [0, 1, 0], 1, band1=1, band2=1)
anomalous_operator('S2', [1, 0, 0], 1, band1=2, band2=2)
anomalous_operator('S2', [0, 1, 0], 1, band1=2, band2=2)
anomalous_operator('D1', [1, 0, 0], 1, band1=1, band2=1)
anomalous_operator('D1', [0, 1, 0], -1, band1=1, band2=1)
anomalous_operator('D2', [1, 0, 0], 1, band1=2, band2=2)
anomalous_operator('D2', [0, 1, 0], -1, band1=2, band2=2)
hopping_operator('lambda1', [0, 1, 0], 1, band1=1, band2=1, tau=2, sigma=1)
hopping_operator('lambda1', [1, 0, 0], -1, band1=1, band2=1, tau=2, sigma=2)
hopping_operator('lambda2', [0, 1, 0], 1, band1=2, band2=2, tau=2, sigma=1)
hopping_operator('lambda2', [1, 0, 0], -1, band1=2, band2=2, tau=2, sigma=2)
anomalous_operator('B1y1', [0, 1, 0], 1j, band1=1, band2=1, type='dx')
anomalous_operator('B1x1', [1, 0, 0], 1j, band1=1, band2=1, type='dy')
anomalous_operator('B1y2', [0, 1, 0], 1j, band1=2, band2=2, type='dx')
anomalous_operator('B1x2', [1, 0, 0], 1j, band1=2, band2=2, type='dy')
