...
for v in np.arange(4, 3, -0.02):
    ...
    # vca(names=['cdw_1', 'V0m', 'V1m'], steps=[0.01]*3, accur=[1e-4, 1e-2, 1e-2], max=[10]*3, hartree=[V0m_H, V1m_H], max_iter=100)
    # vca(names=['cdw_1', 'V0m'], steps=[0.01]*2, accur=[1e-4, 1e-2], max=[10]*2, hartree=[V0m_H], max_iter=100)
    vca(names=['cdw_1'], steps=[0.01], accur=[1e-4], max=[10], hartree=[V0m_H], max_iter=100, hartree_self_consistent=True)
    # f = open('cdw.tsv', 'a')
